...
array=(
  ...
  # Ten nha phan khoi
  "Ten Ban Phan Phoi: `cat /etc/lsb-release | grep -w "DISTRIB_DESCRIPTION" | cut -d "=" -f2`"
  # Ten He dieu hanh 
  "Ten He Dieu Hanh: `cat /etc/lsb-release | grep -w "DISTRIB_ID" | cut -d "=" -f2`"
  # Ten CPU
  ...
  "Dung luong o cung: `df -h /dev/sdb --output=size | grep "G"`"
  "Dung luong con lai: `df -h /dev/sdb --output=avail | grep "G"`"
